...
export class Initialize1563601140063 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "issues" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" text NOT NULL, "estimate_point" integer NOT NULL, "result_point" integer NOT NULL DEFAULT 0, "box_index" integer NOT NULL, "archived" boolean NOT NULL DEFAULT false, "user_id" integer, "issue_box_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9d8ecbbeff46229c700f0449257" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "labels" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "user_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c0c4e97f76f1f3a268c7a70b925" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "issue_boxes" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "user_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c32561676c304199e40496c41ed" PRIMARY KEY ("id"))`);
